...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('website_protein', 'sequence', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40))
    ...
    models = {
        ...
        'website.protein': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sequence': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40'}),
