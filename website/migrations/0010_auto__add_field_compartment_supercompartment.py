...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compartment.supercompartment'
        db.add_column('website_compartment', 'supercompartment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compartment.supercompartment'
        db.delete_column('website_compartment', 'supercompartment')
