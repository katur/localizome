...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.date_scored'
        db.alter_column('website_video', 'date_scored', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Video.date_scored'
        db.alter_column('website_video', 'date_scored', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 4, 11, 0, 0)))
