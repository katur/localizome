...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('website_video', 'strain_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['website.Strain']))
    ...
    models = {
        ...
        'website.video': {
            'Meta': {'ordering': "['protein', 'strain', 'excel_id']", 'object_name': 'Video'},
            ...
            'strain_name': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
