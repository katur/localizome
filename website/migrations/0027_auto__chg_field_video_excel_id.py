...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('website_video', 'excel_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0))
    ...
    models = {
        ...
        'website.video': {
            ...
            'excel_id': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
