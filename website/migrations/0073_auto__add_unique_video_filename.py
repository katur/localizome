...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Video', fields ['filename']
        db.create_unique('website_video', ['filename'])


    def backwards(self, orm):
        # Removing unique constraint on 'Video', fields ['filename']
        db.delete_unique('website_video', ['filename'])
