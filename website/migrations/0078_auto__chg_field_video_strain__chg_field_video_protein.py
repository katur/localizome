...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('website_video', 'strain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Strain'], null=True))

        # Changing field 'Video.protein'
        db.alter_column('website_video', 'protein_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Protein'], null=True))

    def backwards(self, orm):

        # Changing field 'Video.strain'
        db.alter_column('website_video', 'strain_id', self.gf('django.db.models.fields.related.ForeignKey')(default='null', to=orm['website.Strain']))

        # Changing field 'Video.protein'
        db.alter_column('website_video', 'protein_id', self.gf('django.db.models.fields.related.ForeignKey')(default='null', to=orm['website.Protein']))
    ...
    models = {
        ...
        'website.video': {
            ...
            'protein': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['website.Protein']", 'null': 'True'}),
