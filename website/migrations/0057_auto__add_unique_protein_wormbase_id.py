...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Protein', fields ['wormbase_id']
        db.create_unique('website_protein', ['wormbase_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Protein', fields ['wormbase_id']
        db.delete_unique('website_protein', ['wormbase_id'])
