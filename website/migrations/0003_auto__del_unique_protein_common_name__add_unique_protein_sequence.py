...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Protein', fields ['sequence']
        db.create_unique('website_protein', ['sequence'])


    def backwards(self, orm):
        # Removing unique constraint on 'Protein', fields ['sequence']
        db.delete_unique('website_protein', ['sequence'])
