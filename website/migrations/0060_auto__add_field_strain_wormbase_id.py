...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Strain.wormbase_id'
        db.add_column('website_strain', 'wormbase_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Strain.wormbase_id'
        db.delete_column('website_strain', 'wormbase_id')
    ...
    models = {
        ...
        'website.strain': {
            ...
            'genotype': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
