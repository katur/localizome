...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Protein.common_name'
        db.alter_column('website_protein', 'common_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10))

        # Changing field 'Protein.wormbase_id'
        db.alter_column('website_protein', 'wormbase_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=15))

        # Changing field 'Protein.sequence'
        db.alter_column('website_protein', 'sequence', self.gf('django.db.models.fields.CharField')(unique=True, max_length=15))

    def backwards(self, orm):

        # Changing field 'Protein.common_name'
        db.alter_column('website_protein', 'common_name', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))

        # Changing field 'Protein.wormbase_id'
        db.alter_column('website_protein', 'wormbase_id', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))

        # Changing field 'Protein.sequence'
        db.alter_column('website_protein', 'sequence', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))
    ...
    models = {
        ...
        'website.timepoint': {
            ...
            'miyeko_excel_name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
