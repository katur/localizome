...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timepoint.short_name'
        db.add_column('website_timepoint', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5),
                      keep_default=False)

        # Adding field 'Compartment.short_name'
        db.add_column('website_compartment', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timepoint.short_name'
        db.delete_column('website_timepoint', 'short_name')

        # Deleting field 'Compartment.short_name'
        db.delete_column('website_compartment', 'short_name')
