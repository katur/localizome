...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Compartment.supercompartment'
        db.alter_column('website_compartment', 'supercompartment', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Compartment.supercompartment'
        db.alter_column('website_compartment', 'supercompartment', self.gf('django.db.models.fields.CharField')(max_length=50))
