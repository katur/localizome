...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Strain.note'
        db.alter_column('website_strain', 'note', self.gf('django.db.models.fields.CharField')(max_length=75))

    def backwards(self, orm):

        # Changing field 'Strain.note'
        db.alter_column('website_strain', 'note', self.gf('django.db.models.fields.CharField')(max_length=100))
