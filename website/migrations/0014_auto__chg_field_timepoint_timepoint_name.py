...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Timepoint.timepoint_name'
        db.alter_column('website_timepoint', 'timepoint_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30))

    def backwards(self, orm):

        # Changing field 'Timepoint.timepoint_name'
        db.alter_column('website_timepoint', 'timepoint_name', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True))
    ...
    models = {
        ...
        'website.timepoint': {
            ...
            'display_order': ('django.db.models.fields.PositiveSmallIntegerField', [], {'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'timepoint_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'})
        },
        'website.video': {
