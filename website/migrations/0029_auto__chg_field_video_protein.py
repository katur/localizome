...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Video.protein' to match new field type.
        db.rename_column('website_video', 'protein_id', 'protein')
        # Changing field 'Video.protein'
        db.alter_column('website_video', 'protein', self.gf('django.db.models.fields.CharField')(max_length=10))
        # Removing index on 'Video', fields ['protein']
        db.delete_index('website_video', ['protein_id'])


    def backwards(self, orm):
        # Adding index on 'Video', fields ['protein']
        db.create_index('website_video', ['protein_id'])


        # Renaming column for 'Video.protein' to match new field type.
        db.rename_column('website_video', 'protein', 'protein_id')
        # Changing field 'Video.protein'
        db.alter_column('website_video', 'protein_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Protein']))
    ...
    models = {
        ...
        'website.video': {
            ...
            'protein': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
