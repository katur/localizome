...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Strain.genotype'
        db.alter_column('website_strain', 'genotype', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Strain.genotype'
        db.alter_column('website_strain', 'genotype', self.gf('django.db.models.fields.CharField')(max_length=50))
