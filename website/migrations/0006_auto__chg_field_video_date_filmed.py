...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('website_video', 'date_filmed', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Video.date_filmed'
        db.alter_column('website_video', 'date_filmed', self.gf('django.db.models.fields.DateTimeField')())
