...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SignalRaw', fields ['strength']
        db.create_index('website_signalraw', ['strength'])

        # Adding index on 'SignalMerged', fields ['strength']
        db.create_index('website_signalmerged', ['strength'])


    def backwards(self, orm):
        # Removing index on 'SignalMerged', fields ['strength']
        db.delete_index('website_signalmerged', ['strength'])

        # Removing index on 'SignalRaw', fields ['strength']
        db.delete_index('website_signalraw', ['strength'])
