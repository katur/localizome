...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.vector'
        db.delete_column('website_video', 'vector')

        # Deleting field 'Video.strain_name'
        db.delete_column('website_video', 'strain_name')


    def backwards(self, orm):
        # Adding field 'Video.vector'
        db.add_column('website_video', 'vector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Video.strain_name'
        db.add_column('website_video', 'strain_name',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 4, 10, 0, 0), max_length=10),
                      keep_default=False)
    ...
    models = {
        ...
        'website.protein': {
            ...
            'wormbase_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'})
        },
