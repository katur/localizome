...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Protein.in_paper'
        db.add_column(u'website_protein', 'in_paper',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Protein.in_paper'
        db.delete_column(u'website_protein', 'in_paper')
