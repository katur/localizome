...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compartment.extra_short_name'
        db.add_column('website_compartment', 'extra_short_name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compartment.extra_short_name'
        db.delete_column('website_compartment', 'extra_short_name')
