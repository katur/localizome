...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timepoint.miyeko_excel_name'
        db.add_column('website_timepoint', 'miyeko_excel_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'Compartment.miyeko_excel_name'
        db.add_column('website_compartment', 'miyeko_excel_name',
