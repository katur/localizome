...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoNotes.protein'
        db.delete_column('website_videonotes', 'protein_id')


    def backwards(self, orm):
        # Adding field 'VideoNotes.protein'
        db.add_column('website_videonotes', 'protein',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['website.Protein']),
                      keep_default=False)
