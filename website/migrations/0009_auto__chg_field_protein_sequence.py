...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('website_protein', 'sequence', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))

    def backwards(self, orm):

        # Changing field 'Protein.sequence'
        db.alter_column('website_protein', 'sequence', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True))
