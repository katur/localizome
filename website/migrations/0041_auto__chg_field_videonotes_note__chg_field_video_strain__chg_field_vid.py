...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoNotes.note'
        db.alter_column('website_videonotes', 'note', self.gf('django.db.models.fields.CharField')(max_length=700))

        # Changing field 'Video.strain'
        db.alter_column('website_video', 'strain', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Video.filename'
        db.alter_column('website_video', 'filename', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Video.lens'
        db.alter_column('website_video', 'lens', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Video.vector'
        db.alter_column('website_video', 'vector', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Video.mode'
        db.alter_column('website_video', 'mode', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'Video.summary'
        db.alter_column('website_video', 'summary', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'VideoNotes.note'
        db.alter_column('website_videonotes', 'note', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'Video.strain'
        db.alter_column('website_video', 'strain', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Video.filename'
        db.alter_column('website_video', 'filename', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Video.lens'
        db.alter_column('website_video', 'lens', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Video.vector'
        db.alter_column('website_video', 'vector', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Video.mode'
        db.alter_column('website_video', 'mode', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Video.summary'
        db.alter_column('website_video', 'summary', self.gf('django.db.models.fields.CharField')(max_length=5000))
    ...
    models = {
        ...
        'website.video': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
