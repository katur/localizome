...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Strain'
        db.create_table('website_strain', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('vector', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('protein', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Protein'])),
        ))
        db.send_create_signal('website', ['Strain'])


    def backwards(self, orm):
        # Deleting model 'Strain'
        db.delete_table('website_strain')
