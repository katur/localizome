...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Compartment', fields ['name']
        db.create_unique('website_compartment', ['name'])

        # Adding unique constraint on 'Compartment', fields ['miyeko_excel_name']
        db.create_unique('website_compartment', ['miyeko_excel_name'])


        # Changing field 'Video.date_filmed'
        db.alter_column('website_video', 'date_filmed', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'Compartment', fields ['miyeko_excel_name']
        db.delete_unique('website_compartment', ['miyeko_excel_name'])

        # Removing unique constraint on 'Compartment', fields ['name']
        db.delete_unique('website_compartment', ['name'])


        # Changing field 'Video.date_filmed'
        db.alter_column('website_video', 'date_filmed', self.gf('django.db.models.fields.DateField')(default=0))
