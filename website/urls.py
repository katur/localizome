...
urlpatterns = patterns('website.views', # first arg prefix for views
	...
	url(
		r'^spaciotemporal/compartment(?P<compartment>\d{1,2})/timepoint(?P<timepoint>\d{1,2})$',
		'spaciotemporal_both',
		name='spaciotemporal_both_url'
	),
	url(
		r'^spaciotemporal/compartment(?P<compartment>\d{1,2})$',
		'spaciotemporal_compartment',
		name='spaciotemporal_compartment_url'
	),
	url(
		r'^spaciotemporal/timepoint(?P<timepoint>\d{1,2})$',
		'spaciotemporal_timepoint',
		name='spaciotemporal_timepoint_url'
	),
)
